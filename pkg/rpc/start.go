...
// Start rpc server.
func Start[T any](ctx context.Context, discoveryConfig *config.Discovery, prometheusConfig *config.Prometheus, listenIP,
	...
	client, err := NewDiscoveryRegister(discoveryConfig, share)
	if err != nil {
		return err
	}
